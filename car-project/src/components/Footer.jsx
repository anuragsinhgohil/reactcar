            ...
            <div className="copyright">
                <div className="row">
                    <div className="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a className="border-bottom" href="#">Anuragsinh</a>, All Right Reserved.
                        Designed By <a className="border-bottom" href="#">AJ</a>
                        <br />Distributed By: <a className="border-bottom" href="#" target="_blank">Anurag</a>
                    </div>
